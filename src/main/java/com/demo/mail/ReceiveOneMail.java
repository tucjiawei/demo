...
//        String s = "收件人 dongcheng3297370@163.com";
//    	Pattern p = Pattern.compile("收件人\\s*[A-Za-z0-9-_.+%]+@[A-Za-z0-9-.]+\\.[A-Za-z]{2,4}$");
...
//            // 获得邮件内容===============  
            try{
	            ...
	            if(pmm.getBodyText().contains("绕了地球一圈，我们仍然无法找到您要发送的邮件地址，邮件只好先给您捎回来了。")){
